  ...
  return (
    <div className="px-4 py-6 sm:px-6 lg:px-8 max-w-[1200px] mx-auto">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-7">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 tracking-tight">Subjects</h1>
          <p className="text-sm text-gray-500 mt-0.5">Manage curriculum subjects and grading rules</p>
        </div>
